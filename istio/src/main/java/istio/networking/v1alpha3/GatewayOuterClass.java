          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                servers_ = new java.util.ArrayList<istio.networking.v1alpha3.GatewayOuterClass.Server>();
                mutable_bitField0_ |= 0x00000001;
              }
              servers_.add(
                  input.readMessage(istio.networking.v1alpha3.GatewayOuterClass.Server.parser(), extensionRegistry));
              break;
            }
            case 18: {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        istio.networking.v1alpha3.GatewayOuterClass.Server parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (istio.networking.v1alpha3.GatewayOuterClass.Server) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder mergeTls(istio.networking.v1alpha3.GatewayOuterClass.ServerTLSSettings value) {
        if (tlsBuilder_ == null) {
          if (tls_ != null) {
            tls_ =
              istio.networking.v1alpha3.GatewayOuterClass.ServerTLSSettings.newBuilder(tls_).mergeFrom(value).buildPartial();
          } else {
            tls_ = value;
          }
          onChanged();
