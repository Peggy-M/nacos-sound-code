          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                subsets_ = new java.util.ArrayList<istio.networking.v1alpha3.DestinationRuleOuterClass.Subset>();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                portLevelSettings_ = new java.util.ArrayList<istio.networking.v1alpha3.DestinationRuleOuterClass.TrafficPolicy.PortTrafficPolicy>();
                mutable_bitField0_ |= 0x00000001;
              }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                distribute_ = new java.util.ArrayList<istio.networking.v1alpha3.DestinationRuleOuterClass.LocalityLoadBalancerSetting.Distribute>();
                mutable_bitField0_ |= 0x00000001;
              }
              distribute_.add(
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                failover_ = new java.util.ArrayList<istio.networking.v1alpha3.DestinationRuleOuterClass.LocalityLoadBalancerSetting.Failover>();
                mutable_bitField0_ |= 0x00000002;
              }
              failover_.add(
